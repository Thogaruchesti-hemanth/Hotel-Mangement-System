...
function displayHotelInfo(hotel) {
    ...
    costPerRoomElement.textContent = hotel.costPerRoom;
}
    ...
    aadhaarScanPromise.then(aadhaarScanURL => {
        ...
        get(roomRef).then(snapshot => {
            ...
            if (room.status === 'Available') {
                ...
                // Editing the room, skip the "Room is already booked" check
                room.guest = guestName;
                room.checkIn = checkIn;
                room.checkOut = checkOut;
                room.aadhaarNumber = aadhaarNumber;
            ...
            if (room && room.status === 'Booked') {
                ...
                document.getElementById('checkout-form').onsubmit = function(e) {
                    ...
                    const roomData = {
                        ...
                        hotelOwner: room.ownerEmail
                    };

                    // Send data to Google Apps Script Web App
                  fetch('https://script.google.com/macros/s/AKfycbxUuEgI9_JPZ9bzoIEcErNTlRgIdeC9yQPTIPA6nSAmimLgdsHOIBJhrfDKi7B7CJVR/exec', {
                    method: 'POST',
